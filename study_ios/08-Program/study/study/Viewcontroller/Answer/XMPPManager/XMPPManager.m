...
- (BOOL)connect
{
    ...
    NSString *jidString = [NSString stringWithFormat:@"%@@%@/XMPPIOS", userid, [OperatePlist OpenFireServerAddress]];
...
//        [[SingleChatMessageDBManager sharedManager] insertMessageModel:msg];

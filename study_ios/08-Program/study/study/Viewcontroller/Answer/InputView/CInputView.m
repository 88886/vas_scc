...
- (void)layoutViews
{
    ...
    [self.changeButton setFrame:CGRectMake(10, 5, buttonHeight, buttonHeight)];
    ...
    self.inputText = [[UITextView alloc] initWithFrame:CGRectMake(textLineX, self.changeButton.top + 2, textLineW, buttonHeight)];
    ...
    [self.moreButton setFrame:CGRectMake(Main_Width - buttonHeight - 15, 5, buttonHeight, buttonHeight)];
    self.changeButton.backgroundColor = [UIColor clearColor];
    ...
    [self.faceButton setFrame:CGRectMake(CGRectGetMinX(self.moreButton.frame) - buttonHeight-15, 5, buttonHeight, buttonHeight)];

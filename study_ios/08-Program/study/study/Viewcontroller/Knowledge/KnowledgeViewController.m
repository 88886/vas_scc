...
@interface KnowledgeViewController ()<JZLSegmentControlDelegate,PopMenuViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,LectureNetCoreDelegate,LXActionSheetDelegate>
{

...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_editBtn addTarget:self action:@selector(choseDocumentTodelete:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)changeFrameWithEdit:(BOOL)edit
{
    ...
    if (_editBtn.selected) {
        [_editBtn setImage:[UIImage imageNamed:@"Collection_More"] forState:UIControlStateNormal];
    }else{
        [_editBtn setImage:[UIImage imageNamed:@"Document_Chose"] forState:UIControlStateNormal];
    }
    [self setClassViewFrame];
}
